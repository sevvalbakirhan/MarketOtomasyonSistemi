...
namespace market
{
    ...
    public partial class KasapPanel : Form
    {
        ...
        private void KasapPanel_Load(object sender, EventArgs e)
        {
            timer1.Start();
        ...
        private void btn_bonfile_Click(object sender, EventArgs e)
        {

            string sadeceSayi = new string(lbl_bonfile.Text.Where(Char.IsDigit).ToArray());
        ...
        {
            string sadeceSayi = new string(lbl_tavuk.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_somon_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_somon.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_kıyma_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_kıyma.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_sucuk_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_sucuk.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_salam_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_salam.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_sosis_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_sosis.Text.Where(Char.IsDigit).ToArray());
