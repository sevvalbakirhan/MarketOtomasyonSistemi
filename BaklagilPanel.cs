...
namespace market
{
    public partial class BaklagilPanel : Form
    {
        ...
        {
            string sadeceSayi = new string(lbl_bulgur.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_fasulye_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_fasulye.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_mercimek_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_mercimek.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_nohut_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_nohut.Text.Where(Char.IsDigit).ToArray());
        ...
        {
            string sadeceSayi = new string(lbl_pirinc.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_börülce_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_börülce.Text.Where(Char.IsDigit).ToArray());
        ...
        private void btn_bakla_Click(object sender, EventArgs e)
        {
            string sadeceSayi = new string(lbl_bakla.Text.Where(Char.IsDigit).ToArray());
